...
func coordinatorFlowStages() []flowStage {
	...
	prepareOps.Fields = append(prepareOps.Fields, flowField{Flag: "witness-quorum", Label: "Agreed minimum witnesses per phase (2-32; do not lower it to fit available receipts)", Default: "2", Kind: "number"})
