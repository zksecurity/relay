...
func baseRoleFlowStages(role string) []flowStage {
	...
	case "release-signer":
		...
		stages = append(stages, flowStage{ID: "sign", Label: "Review, sign and hand off", Tasks: []flowTask{sign, releaseVerifyFlow(), handoff("handoff", "Transfer only the signed public release", "Use the upload-station role to transfer the signed public release. Keep your private key offline; retain the verification and transfer records. Complete any required production decision before release authorization.")}})
	case "upload-station":
