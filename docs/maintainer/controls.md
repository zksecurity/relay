...
| `DECISION-PREPARE-01` | Decision signer | `mpc-ceremony decision prepare` strictly parses the draft, derives release and decision IDs, and verifies ceremony, exact signed circuit, source, and role bindings. | Canonical decision digest and evidence-inventory digest. |
