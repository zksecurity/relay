...
export function parseSetup(bytes) {
  ...
  require(counts.get("coordinator") === 1 && counts.get("release-signer") === 1 && counts.get("auditor") >= 1, "Setup requires one coordinator, one release signer and at least one auditor");
