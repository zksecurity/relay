...
| `PART-RUN-01` | Contribution | `relay participant run` repeats the turn check before expensive work and authenticates all required chain inputs. For Phase 2 it also verifies Phase 1 closure, beacon, seal, and Phase 2 initialization before sampling contribution randomness. | Passing native contribution and verification receipts. |
